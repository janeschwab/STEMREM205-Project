...
# 3. Interactome Analysis - removed 2/11
# 4. Figures/Data Analysis

dim(PDAC_TISSUE_1.data) # rows are genes, columns are barcodes
overlap_micb <- grep("GGAATCTAGAAGCTCG", colnames(normalized_counts))
overlap_somatic <- grep("GGAATCTAGAAGCTCG", colnames(PDAC_TISSUE_1.data))
colnames(PDAC_TISSUE_1.data)
